    ...
    Statement = [
      {
        ...
        Resource = [
          ...
          data.aws_secretsmanager_secret.bland_api_key.arn
        ]
      }
    ]
  })
...
moved {
  from = aws_iam_role_policy_attachment.systemadmin_access_attachment
  to   = aws_iam_role_policy_attachment.admin_access_attachment
}
